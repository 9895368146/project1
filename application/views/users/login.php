            ...
            <div class="login-panel panel panel-success">
              ...
              $error_msg= $this->session->flashdata('error_msg');
                ...
                <div class="panel-body">
                    <form role="form" method="post" action="<?php echo base_url('index.php/users/login_user'); ?>">
                        <fieldset>
                ...
                <center><b>You are not registered ?</b> <br></b><a href="<?php echo base_url('index.php/users/register'); ?>">Register here</a></center><!--for centered text-->
